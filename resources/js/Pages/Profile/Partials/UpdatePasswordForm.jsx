...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900">Modifier votre mot de passe</h2>

                <p className="mt-1 text-sm text-gray-600">
                    Assurez vous d'utiliser un mot de passe long, contenant des lettres majuscules et minuscules.
                </p>
            </header>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0"
                    >
                        <p className="text-sm text-gray-600">Votre compte a bien été modifié.</p>
                    </Transition>
                </div>
            </form>
        </section>
